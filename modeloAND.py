...
train_path = os.path.join(os.path.dirname(__file__), 'app\static\DataAND\Training')
val_path = os.path.join(os.path.dirname(__file__), 'app\static\DataAND\Validation')
print(train_path)

def exist_model():
    return (os.path.exists(os.path.join(os.path.dirname(__file__),'cnnAND.h5')) and os.path.exists(os.path.join(os.path.dirname(__file__), 'cnn_pesosAND.h5')))
...
def entrenamiento():
  ...
  train = os.path.join(os.path.dirname(__file__), 'app\static\DataAND\Training')
  val = os.path.join(os.path.dirname(__file__), 'app\static\DataAND\Validation')
  ...
  if not exist_model(): 
    ...
    cnn.save(os.path.join(os.path.dirname(__file__), "cnnAND.h5"))    
    cnn.save_weights(os.path.join(os.path.dirname(__file__), "cnn_pesosAND.h5"))
    ...
    altura,anchura=50,50    
    modelo= os.path.join(os.path.dirname(__file__), "cnnAND.h5")   
    pesos= os.path.join(os.path.dirname(__file__), "cnn_pesosAND.h5")   
...
def val_image(val_path):
  ''' Valida la '''
  if (os.path.exists(os.path.join('cnn.h5')) and os.path.exists(os.path.join('cnn_pesosAND.h5'))):
    #Elegir la imagen a clasificar    

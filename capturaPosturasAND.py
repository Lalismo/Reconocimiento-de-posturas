...
def CapturePosture(category:int, filename:list):
    ...
    data = os.path.join(staticPath,'DataAND')
    ...
    while True:
        ...
        if lm:
            ...
            if ((90 <= neck_inclination <= 110)  and  (70 <= torso_inclination <= 95)) and count_files_by_extension (goodposture, 'jpg') < 500:
                good_frames += 1
            ...
            elif ((111 <= neck_inclination <= 125) and (96 <= torso_inclination <= 105))  and count_files_by_extension(regularposture, 'jpg') < 500:
            ...
            elif ((126 <= neck_inclination <= 180) and (106 <= torso_inclination <= 115)) and count_files_by_extension(badposture, 'jpg') < 500:

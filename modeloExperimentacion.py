...
def entrenamiento(epocas, pasos):
  ...
  if not exist_model(): 
    ...
    cnn.save(os.path.join(os.path.dirname(__file__), "cnn_experimentacion.h5"))    
    cnn.save_weights(os.path.join(os.path.dirname(__file__), "cnn_pesos_experimentacion.h5"))
...
def val_image(val_path):
  ...
  if (os.path.exists(os.path.join('cnn_experimentacion.h5')) and os.path.exists(os.path.join('cnn_pesos_experimentacion.h5'))):
    #Elegir la imagen a clasificar    

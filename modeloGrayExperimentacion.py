...
def entrenamiento(epocas, pasos):
    ...
    if not os.path.exists(os.path.join(os.path.dirname(__file__), 'cnnGray_experimentacion.h5')) and not os.path.exists(
        os.path.join(os.path.dirname(__file__), 'cnn_pesosGray_experimentacion.h5')):
        ...
        cnn.save_weights(os.path.join(os.path.dirname(__file__), "cnn_pesosGray_experimentacion.h5"))
        ...
        pesos = os.path.join(os.path.dirname(__file__), "cnn_pesosGray_experimentacion.h5")
